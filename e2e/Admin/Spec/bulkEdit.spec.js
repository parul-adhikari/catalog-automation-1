...
describe('Verify transition to various statuses from admin panel using bulk edit functionality', function () {
       ...
       beforeAll(function () {
           dictionary.dataDictionary.waitForElement(dictionary.dataDictionary.action);
       ...
       it('Get ID of free content', function () {
           contentListingPage.getContent(dictionary.dataDictionary.status2);
       });

       it('Get ID of available content', function () {
           contentListingPage.getContent(dictionary.dataDictionary.status3);
       });

       it('Get ID of purchased with request content', function () {
           contentListingPage.getContent(dictionary.dataDictionary.status4);
       });

       it('Get ID of un-published content', function () {
           contentListingPage.getContent(dictionary.dataDictionary.status1);
       });
